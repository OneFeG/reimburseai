...
import { kybApi, type KYBStatusResponse, type KYBSubmissionRequest } from "@/lib/api";
...
const statusConfig = {
    unsubmitted: {
        ...
        label: "Not Submitted",
        description: "Submit your business verification to unlock full platform features."
    },
    pending: {
        icon: Clock,
        ...
        label: "Under Review",
        description: "Your submission is being reviewed. This typically takes 1-2 business days."
    },
    under_review: {
        icon: Clock,
        color: "text-blue-500",
    ...
    approved: {
        ...
        label: "Verified",
        description: "Your business has been verified. All platform features are unlocked."
    },
    rejected: {
        icon: XCircle,
        color: "text-red-500",
        ...
        label: "Rejected",
        description: "Your submission was rejected. Please review the notes and resubmit."
    },
};
...
export default function KYBPage() {
    ...
    const config = statusConfig[status as keyof typeof statusConfig] || statusConfig.unsubmitted;
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-8">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold text-white tracking-tight">Business Verification</h1>
                    <p className="text-gray-400">KYB (Know Your Business) compliance verification.</p>
                </div>
                <button
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className={`px-2 py-0.5 rounded-full text-xs font-medium border ${config.bgColor} ${config.borderColor} ${config.color}`}>
            ...
            <div className="bg-[#0A0A0A] border border-[#333] rounded-xl p-4">
                <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-gray-400">
                        <p className="font-medium text-gray-300 mb-1">Why is KYB required?</p>
                        <p>
                            Know Your Business (KYB) verification helps us comply with financial regulations 
                            and ensure the security of all transactions. Verified businesses unlock higher 
                            limits and full access to Treasury Vault features.
                        </p>
                    </div>
                </div>
            </div>
