...
export function HeroBackground() {
  ...
  useEffect(() => {
    ...
    class Particle {
      ...
      constructor() {
        ...
        this.color = Math.random() > 0.5 ? "#22D3EE" : "#8B5CF6";
      }
  ...
  return (
    <>
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-cyan-400/5 rounded-full blur-[150px] pointer-events-none" />
    </>
  );
}
