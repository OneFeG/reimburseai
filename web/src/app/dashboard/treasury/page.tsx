...
const demoRecentTransactions = [
  ...
  },
  {
    ...
    txHash:
      "0xdef789ghi012345def789ghi012345def789ghi012345def789ghi012345def7",
  ...
  },
  {
    ...
    txHash:
      "0xghi345jkl678901ghi345jkl678901ghi345jkl678901ghi345jkl678901ghi3",
    receiptUrl: "",
  },
  {
    id: "4",
    ...
    txHash:
      "0xjkl901mno234567jkl901mno234567jkl901mno234567jkl901mno234567jkl9",
...
function exportTransactionsToCSV(
  transactions: typeof demoRecentTransactions,
  month?: string,
) {
          ...
          >
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5">
                ...
                <ul className="text-sm text-white/70 space-y-1">
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-cyan-400" /> Date of
                    transaction
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-cyan-400" /> Employee wallet
                    address
                  </li>
                  <li className="flex items-center gap-2">
                  ...
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-cyan-400" /> Transaction hash
                    (on-chain proof)
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-cyan-400" /> Link to receipt
                    image
                  </li>
                </ul>
              </div>
              ...
              <p className="text-xs text-white/40">
                This report provides a complete audit trail for tax compliance
        ...
        <div className="card">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-lg font-semibold text-white">Avalanche Fuji</p>
            </div>
          </div>
        </div>
        <div className="card">
