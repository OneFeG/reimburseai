...
const teamMembers = [
  {
    ...
    details: [
      ...
      {
        icon: GraduationCap,
        text: "Systems Engineering & International Business",
      },
    ],
    social: {
...
const values = [
  {
    ...
    title: "Speed First",
    description:
      "We believe reimbursements should be instant. Days of waiting for money you've already spent is unacceptable in 2025.",
  },
  {
    icon: Target,
    title: "Solve Real Problems",
    description:
      "We don't build features for the sake of it. Every line of code addresses genuine pain points for companies and employees.",
  },
  {
    icon: Users,
    title: "People-Centric",
    description:
      "Technology should serve people, not the other way around. We automate the tedious so humans can focus on what matters.",
  },
  {
    icon: Globe,
    title: "Borderless by Design",
    description:
      "Remote teams, global companies, instant international payments. We're building for the future of work.",
  },
];
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/50 max-w-3xl mx-auto leading-relaxed">
              We&apos;re building the future where expense reimbursements
              finally match the speed at which modern teams work. No more
              waiting weeks for money you&apos;ve already spent.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            <div className="glass rounded-3xl p-8 md:p-12">
              ...
              <div className="space-y-6 text-white/70 leading-relaxed">
                <p>
                  In our daily work, everything is{" "}
                  <span className="text-cyan-400 font-medium">instant</span>: We
                  spin up servers across the globe in seconds, deploy code with
                  a single command, and collaborate in real time across time
                  zones.
                </p>

                <p>
                  Yet when it came to something as basic as a $50 cloud bill or
                  a team dinner receipt, the process felt stuck in the stone
                  age: Scan the receipt, fill out endless forms, chase
                  approvals, and wait weeks for a bank transfer that might
                  arrive... eventually.
                </p>

                <p className="text-white/90 text-lg border-l-2 border-cyan-400 pl-6 my-8">
                  It was absurd. We were building in the 21st century, but our
                  financial infrastructure was still running on 20th-century
                  rails.
                </p>

                <p>
                  &quot;Modern&quot; expense tools? They just digitized the same
                  slow, manual nightmare — fancier forms, same delays, same
                  frustration. We didn&apos;t want a slightly faster version of
                  the old process. We wanted the pain to{" "}
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="heading-3 text-white">
                  Our Solution: Pay-to-Go
                </h2>
              </div>

              <div className="space-y-6 text-white/70 leading-relaxed">
                <p>
                  That&apos;s when it clicked: The real breakthrough isn&apos;t
                  better software — it&apos;s{" "}
                  <span className="text-cyan-400 font-medium">
                    {" "}
                    automating the actual money movement
                  </span>
                  .
                </p>
                ...
                <p>
                  ...
                  <span className="text-white">AI (GPT-4o Vision)</span> for
                  instant, accurate receipt verification with{" "}
                  <span className="text-white">
                    blockchain-powered instant payments
                  </span>{" "}
                  in USDC on Avalanche, we eliminated waiting periods
                  completely.
                </p>
                ...
                <p>
                  Receipts get snapped, AI audits in seconds, approvals happen
                  automatically (or with human oversight if needed), and funds
                  land in your wallet in under 5 seconds — no paperwork, no
                  delays, no excuses.
                </p>
              </div>
            </motion.div>
